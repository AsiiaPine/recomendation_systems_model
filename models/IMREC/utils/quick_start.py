...
def quick_start(model, dataset, config_dict, save_model=True):
    ...
    for hyper_tuple in combinators:
        ...
        if test_result[val_metric] > best_test_value:
            ...
            trainer.plot_train_loss(show=False, save_path=f'plots/best_{hyper_tuple}_')
            trainer.plot_eval_metric(show=False, save_path=f'plots/best_eval_{hyper_tuple}_')
    ...
    # log info
    logger.info('\n============All Over=====================')
    # trainer.plot_train_loss(show=False, save_path='plots/best_')
    # trainer.plot_eval_metric(show=False, save_path='plots/best_eval_')
